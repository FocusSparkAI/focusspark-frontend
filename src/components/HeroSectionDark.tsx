...
import { Sparkles, ChevronDown, Target, Brain, Zap, BookOpen } from 'lucide-react';
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#10121a] gradient-wave">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-20 py-20 grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <motion.p
            className="text-xl text-[#b0b8c4] mb-8 max-w-xl"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <Button
              ...
              className="border-2 border-white/20 bg-transparent text-white hover:bg-white/10 hover:text-white hover:scale-105 transition-all px-8 py-6"
            >
              Learn the Science
            </Button>
            <Button
